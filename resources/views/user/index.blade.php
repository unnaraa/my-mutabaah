...
<head>
    ...
    <style>
        body {
            ...
            outline: 1px solid red; /* Membantu lihat elemen tersembunyi */
        ...
        .navigation {
            ...
            border-radius: 10px;
            overflow: hidden;
            z-index: 10; /* Pastikan angka cukup besar */
            position: relative;
        }
        .navigation ul {
            list-style: none;
    ...
    flex-direction: column;
    align-items: center;
    gap: 10px; /* Jarak antara logout dan profile */
}
...
.logout-icon .profile-icon {
    font-size: 25px; /* Icon Profile lebih besar */
}
